...
-- spatial_size = input: 128 -- tiny
features:add(nn.SpatialConvolution(3,32,4,4,2,2))
-- spatial_size = 63 -tiny
...
-- spatial_size = 2
features:add(nn.View(128*4):setNumInputDims(3))

features:cuda()

local classifier = nn.Sequential()
classifier:add(nn.Dropout(0.5))
classifier:add(nn.Linear(128*4,512))
